...
/// Represents an active workout in progress
struct ActiveWorkout: Identifiable, Equatable {
    ...
    var currentPace: Double? = nil // seconds per km
    var currentSpeed: Double? = nil // meters per second
    ...
    var distanceFormatted: String {
        ...
        let convertedDistance = distance / distanceUnit.metersPerUnit
        return String(format: "%.2f %@", convertedDistance, distanceUnit.shortName)
    }
    ...
    var paceFormatted: String? {
        ...
        return String(format: "%d:%02d /%@", minutes, seconds, distanceUnit.shortName)
    }
}
